...
\begin{multicols*}{4}
	...
	\textbf{Small values}: $R(3,3)=6$, $R(3,4)=9$, $R(3,5)=14$, $R(3,6)=18$, $R(3,7)=23$, $R(3,8)=28$, $R(3,9)=36$; $R(4,4)=18$, $R(4,5)=25$, $R(4,6)=41$. \\
	...
	\textbf{Figure 9.3.2 (Kim).} A symmetric map of twelve mutually adjacent $2$-pires. \\
	...
	\textbf{Inequality:} With $p = |V|$, $q = |E|$, $\displaystyle \frac{q - 3p + 6}{3} \le \sigma(G)$.
