...
public class MaxPQ<Key extends Comparable<Key>> {
  ...
  \end{itemize}
  \begin{tabulary}{\linewidth}{@{}LLLLLL@{}} \toprule
    algo & wrst search & wrst insert & avg search & avg insert & efficient for ordered ops \\ \midrule
    sequential search & $N$ & $N$ & $N/2$ & $N$ & no \\
    binary search & $\lg N$ & $ N$ & $\lg N$ & $N/2$ & yes \\
    BST & $N$ & $N$ & $1.39 \lg N$ & $1.39 \lg N$ & yes \\ \bottomrule
  \end{tabulary}
  ...
  \textbf{Worst and Avg case:} Search, $c \lg N$, insert $c \lg N$, delete $c \lg N$ \\
  Ordered operations: yes, key interface is compareTo()
  ...
  Search, insert, delete: $2 \lg N$ in the worst case, $1.0 \lg N$ in the average case
  Ordered operations: yes, key interface is compareTo()
