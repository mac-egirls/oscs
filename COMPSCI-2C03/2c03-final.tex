...
public class MaxPQ<Key extends Comparable<Key>> {
  ...
  \section{Symbol Tables \& Binary Search Trees}
  ...
  \subsection{Prim's}
  Lazy: Maintain a PQ of edges with at least one endpoint in $T$ \\
  ...
  Eager: Maintain a PQ of verticies connected by an edge to T,
