...
class Node {
    ...
    until it is in the right position. The number of operations it takes to sort an array depends on the degree of disorder (how unsorted the array is). This makes it an adaptive algorithm.
    $\Omega(N), O(n^2)$
