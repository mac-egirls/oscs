...
\begin{multicols*}{6}
  ...
  \tikz[remember picture,overlay] \node[opacity=0.2,inner sep=0pt] at (current page.center){\includegraphics[height=0.8\paperheight]{had-to-do-it-to-em.png}};
...
public class SensorData {
  ...
  \section{Bug Counting}
  Number of bugs range from $N_1 = (C-S)*M/S$ to $N_2 = (M-S)*C/S$\\
  Where $N_x$ is the actual number of bugs. $C$ is the number of bugs found. $M$ is how many bugs another party found. 
  $S$ is the common bugs both parties found.
