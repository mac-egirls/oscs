...
\ifthenelse{\lengthtest { \paperwidth = 11in}}
    { \geometry{top=.25in,left=.1in,right=.1in,bottom=.35in} }
...
public class ActualMedOffice {
  ...
  allowing for actions before / after request gets through.
  Eg: Database proxy
...
public class Course implements Subject {
  ...
  @Override
  public void update() { for (Observer o : students) { o.update(); } } }
