...
\end{lstlisting}
    ...
    \textbf{Conventional single level} page table stores an entry for each virtual page.
    \textbf{Inverted page table} stores an entry for each physical frame.
    Conventional single level page table stores an entry for each virtual page.
    Inverted page table stores an entry for each physical frame.
