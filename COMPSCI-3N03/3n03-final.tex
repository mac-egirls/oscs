...
\begin{multicols*}{4}
	...
	\textbf{Vertical:} Between adjacent layers (service), like a gateway \\
	\textbf{Horizontal:} Between same layers (protocol)

	\subsection{OSI Model}
	Open Systems Interconnection. Makes essential concepts explicit (services, interfaces, protocols). Each layer adds its own header to data. \\
