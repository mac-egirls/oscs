...
\begin{multicols*}{3}
    ...
    \begin{tabulary}{\linewidth}{@{}lLL@{}}
        ...
        (11.24) & \textbf{Definition.} For $E_s$, a set expression, $E_p$, a predicate expression can be calculated: & $\emptyset \to false, \mathbf{U} \to true, \cup \to \lor, \cap \to \land, \sum \to \neg$ \\
