...
\begin{multicols*}{3}
    ...
    \begin{tabulary}{\linewidth}{@{}lLL@{}}
        ...
        (14.23) & \textbf{Distributivity of $\circ$ over $\cup$:} \; $\rho \circ (\sigma \cup \theta) = \rho \circ \sigma \cup \rho \circ \theta$\\
        & \;\;\;\;\;\;\;\; $(\sigma \cup \theta) \circ \rho = \sigma \circ \rho \cup \theta \circ \rho$\\
        (14.24) & \textbf{Distributivity of $\circ$ over $\cap$:} \; $\rho \circ (\sigma \cap \theta) \subseteq \rho \circ \sigma \cap \rho \circ \theta$\\
        ...
        (14.25) & $\rho^m \circ \rho^n = \rho^{m+n}$ (for $m \geq 0,n \geq 0$) \\
