...
\begin{multicols*}{3}
    ...
    \begin{tabulary}{\linewidth}{@{}lLL@{}}
        ...
        (12.45) & \textbf{Checklist} & (a) $P$ is $true$ before execution of the loop. Q $\Rightarrow$ P[initial variables] \\
        & & (b) P is a loop invariant: $\{P \land B\} S \{P\}$ \\
        & & (c) Execution of the loop terminates. P $\land$ B $\Rightarrow$ T > 0 \\
